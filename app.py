...
if BOT_TOKEN or db_get_bots():
 ...
 # Parse page: look for trailing "_p "
 page = 0
 ...
 # URL pattern: /static/uploads/videos/ /index.m3u8
 if not base_url:
 ...
 if not message_text:
 await update.message.reply_text("Cú pháp: /sendall ")
 return
 ...
 await update.message.reply_text("Cú pháp: /ban ")
 return
 ...
 "To enable the bot: add TOKEN= to the .env file, "
